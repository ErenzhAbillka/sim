...
HD_PWD='O:/Study/FPGA_prj/project_3_sim/ov5640_sd.runs/system_util_vector_logic_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_util_vector_logic_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_util_vector_logic_1_0.tcl
